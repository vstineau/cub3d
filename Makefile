...
display_ascii_art :
	@echo "$(BGHI_BLUE)$(B_BLACK)                  ,   __, ,                          $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)  _.._         )\\/(,-' (-' \`.__                      $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)  /_   \`-.      )'_      \` _  (_    _.---._          $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK) // \\     \`-. ,'   \`-.    _\\\`.  \`.,'   ,--.\\         $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)// -.\\       \`        \`.  \\\`.   \`/   ,'   ||         $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)|| _ \`\\_         ___    )  )     \\  /,-'  ||         $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)||  \`---\\      ,'__ \\   \`,' ,--.  \\/---. //          $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK) \\\\\\\\  .---\`.   / /  | |      |,-.\\ |\`-._ //           $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)  \`..___.'|   \\ |,-| |      |_  )||\\___//            $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)    \`.____/    \\\\\\\\\\\\O| |      \\o)// |____/             $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)         /      \`---/        \\-'  \\                  $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)         |        ,'|,--._.--')    \\                 $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)         \\       /   \`n     n'\\    /                 $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)          \`.   \`<   .::\`-,-\'::.),'                  $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)           \`.   \\-.____,^.   /,'                     $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)              \`. ;\`.,-V-.-.\`v'                       $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)                \\| \\     \` \\|\\                       $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)                 ;  \`-^---^-'/                       $(RESET)"
	@echo "$(BGHI_BLUE)$(B_BLACK)                  \`-.______,'                        $(RESET)"
	@echo "$(RESET)"
